...
from apps.wallet.views import (
    ...
    DecalPrintView,
    DecalRevokeView,
    PaymentPointCloseView,
    PaymentPointListCreateView,
    QRChargeView,
    QRDisputeOpenView,
...
urlpatterns = [
    ...
    path('pos/payment-points/', PaymentPointListCreateView.as_view(), name='pos-payment-points'),
    path('pos/payment-points/<int:point_id>/close/', PaymentPointCloseView.as_view(), name='pos-payment-point-close'),
    path('pos/payment-points/<int:point_id>/decal/', DecalPrintView.as_view(), name='pos-decal-print'),
    path('pos/counter/', CounterFeedView.as_view(), name='pos-counter-feed'),
    path('pos/decals/<int:decal_id>/pdf/', DecalPDFView.as_view(), name='pos-decal-pdf'),
    path('pos/decals/<int:decal_id>/revoke/', DecalRevokeView.as_view(), name='pos-decal-revoke'),
