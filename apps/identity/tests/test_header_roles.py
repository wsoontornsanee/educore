...
class HeaderRolesTests(TestCase):
    ...
    def test_shows_role_label_in_header(self):
        ...
        self.client.force_login(self.user)
        self.assertContains(self.client.get(reverse('console:coming_soon')), 'data-testid="header-roles">Teacher<')
    ...
    def test_same_role_at_two_schools_reads_once_and_roles_join(self):
        ...
        self.assertEqual(self._header_roles(), ['School Admin', 'Teacher'])
    ...
    def test_platform_role_included(self):
        ...
        self.assertEqual(self._header_roles(), ['Platform Operator'])
